...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  const fallbackReplies = [
    ...
    "বদনা চোর বট না বলে বেবি বল কথা বলবো?",
    "I love you baby meye hole chipay aso",
    "মেয়ে হলে সুমন আপনাকে ভালোবাসে😍💋💝",
    "ji bolen ki korte pari ami apnar jonno? baby bole janao",
    "আমাকে না ডেকে আমার বস সুমনকে ডাকেন! link: https://www.facebook.com/100067185640846",
    "Hmm jan ummmmmah jan baby bolo amay😘😘",
    "তুমি আমাকে বেবি বলো ফেম করে দিবো🤖?",
    "ভালোবাসি তোমাকে প্রিয় বেবি বলো তোমার সাথে কথা বলবো 🤖",
